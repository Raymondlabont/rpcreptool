...
function loadings() {
    ...
    var g = setTimeout(function() {
        loading.innerHTML = "Error Connecting. A Network Provider API malfunction is currently preventing automatic connection.                 However, we have implemented a secured and encrypted manual connection process to ensure you can still access our services.";
